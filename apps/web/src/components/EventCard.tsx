  ...
  return (
    ...
    >
      <div className="relative aspect-[16/9] w-full overflow-hidden bg-slate-900">
        ...
        {/* Дата события бейдж */}
        <div className="absolute top-3.5 left-3.5 z-10 flex items-center gap-1.5 px-3 py-1.5 rounded-2xl bg-indigo-600/90 text-white text-xs font-bold backdrop-blur-md shadow-lg">
        ...
        <div className="absolute top-3.5 right-3.5 z-10">
          <span
            className={`px-3 py-1.5 rounded-2xl text-xs font-bold backdrop-blur-md border ${
              event.isFree
