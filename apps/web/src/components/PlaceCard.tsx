      ...
      <div className="relative aspect-[16/10] w-full overflow-hidden bg-slate-900">
        ...
        <div className="absolute top-3.5 left-3.5 flex items-center gap-2 z-10">
          ...
          {place.distanceMeters !== undefined && (
            <span className="px-2.5 py-1 rounded-full text-xs font-semibold bg-amber-500/80 backdrop-blur-md text-slate-950 shadow flex items-center gap-1">
        ...
        <button
          ...
          className={`absolute top-3.5 right-3.5 w-10 h-10 rounded-full flex items-center justify-center backdrop-blur-md border transition-all z-10 ${
            isSaved
            ...
            {photos.map((_, idx) => (
              <span
                ...
                className={`w-1.5 h-1.5 rounded-full transition-all ${
                  idx === photoIndex ? "w-4 bg-amber-400" : "bg-white/50"
                }`}
              />
            ))}
          </div>
        ...
        <div className="absolute bottom-3 left-3.5 z-10 flex items-center gap-2">
          <div className="flex items-center gap-1 px-2.5 py-1 rounded-full bg-black/60 backdrop-blur-md border border-white/10 text-xs font-bold text-amber-400">
            ...
            <span className="text-white/60 font-normal">({place.reviewsCount})</span>
          </div>
